...
function demoNoMoves(){
 ...
 if(!state.game){if(challengeUsed()){toast('今日挑战已结束，请切换到次日');return;}state.game={tiles:[],date:day(),count:0,started:Date.now(),stashed:null};state.playedDays.push(day());state.attempts=1;}
