...
const loadManifest = async () => {
  ...
  try {
    ...
    if (
      nextManifest.fileName !== expectedFileName
      || nextManifest.releaseVersion !== "2.0.0"
      || nextManifest.product !== "Codex Confirmation Bar"
      || nextManifest.platform !== `macos-${architecture}`
      || nextManifest.architecture !== architecture
    ) {
