globalThis.HUB_PROJECT_MEDIA = Object.freeze({
  ...
  "codex-thread-workbench": Object.freeze({
    src: "./assets/hub-showcase/codex-thread-workbench.webp?v=20260915-v239-portrait",
    alt: "Codex 待确认悬浮助手功能画面",
    position: "center",
    layout: "wide",
    fallback: "Codex 待确认悬浮助手",
    feature: "左侧竖版待确认任务与一键处理",
    accent: "#0d9488",
    visualKind: "product",
  }),
  ...
  "brick-character-copy-preview": Object.freeze({
    src: "./assets/hub-showcase/brick-character-copy-preview.webp?v=20260903-hand-preview",
    alt: "砖块小人与随身小物图鉴功能画面",
    position: "center",
    layout: "wide",
  ...
  "v-curve-tool": Object.freeze({
    src: "./assets/hub-showcase/v-curve-tool.webp?v=20260908-v150-dual-model",
    alt: "V曲线对比工具真实关卡分析画面",
    position: "center",
    layout: "wide",
    fallback: "V曲线对比工具",
    feature: "双模型、双侧关卡库与参考图复现",
    accent: "#7aa2ff",
    visualKind: "data",
  }),
