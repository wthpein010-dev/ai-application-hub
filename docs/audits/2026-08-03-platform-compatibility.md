...
| `planmap` | 思维导图快捷工具 | 工程在线体验 | Windows：现代浏览器 | macOS：现代浏览器 | [工程体验](https://wthpein010-dev.github.io/ai-application-hub/projects/planmap/index.html)；源码附件为 [planmap-source.zip](https://wthpein010-dev.github.io/ai-application-hub/downloads/planmap-source.zip)，不作为系统安装包 |
| `simuai` | SimuAI 万物实验室 | 工程在线体验 | Windows：现代浏览器 | macOS：现代浏览器 | [工程体验](https://wthpein010-dev.github.io/ai-application-hub/projects/simuai/index.html)；公开版从 12 个受控实验中本地匹配，不调用远程模型 |

## 结论

- 26 个项目都可在 Windows 与 macOS 上通过网页查看或体验。
