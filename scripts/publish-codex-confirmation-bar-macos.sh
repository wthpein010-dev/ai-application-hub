...
workbench_root="${repository_root}/build/codex-thread-workbench"
if [[ -z "${output_root}" ]]; then
  output_root="${workbench_root}/artifacts/release"
fi

project="${workbench_root}/src/CodexThreadWorkbench/CodexThreadWorkbench.csproj"
...
publish_directory="${output_root}/confirmation-publish-${runtime}"
...
echo "macOS Confirmation Bar package: ${archive_path}"
