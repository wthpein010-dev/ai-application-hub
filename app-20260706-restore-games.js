...
const pageTextTargets = [
  ...
  { key: "hero.title", label: "主页标题", selector: ".showcase-copy h1" },
  { key: "hero.description", label: "主页描述", selector: ".showcase-lead", multiline: true },
...
const defaultApps = [
  ...
  },
  {
    ...
    status: "engineering",
    badge: "工程体验",
    brief: "同步 Unity 正式配置的45个砖块小人，默认全解锁；打开游戏式详情即可检查名字、获取文案与图鉴描述的真实换行。",
    problem: "角色文案放在配置表里难以提前发现详情框换行、溢出和孤行标点，美术与策划也无法快速横向检查全部角色。",
    aiUse: "AI 参与 Unity 配置与贴图同步、角色分层还原、图鉴详情复刻、视觉位置统计和响应式排版验收。",
