...
const defaultApps = [
  ...
  },
  {
    ...
    status: "assistant",
    badge: "网页情报",
    brief: "贴吧式整理 X 上 Tibo、马斯克、Codex 与 OpenAI 官方发言，每两小时检查 Token／额度重置预告；首屏硬提醒可展开中英文内容、原因和可核验时间线。",
    problem: "Token 重置预告、完成确认和消耗异常原因散落在 Tibo 与用户帖子里，逐条刷 X 很容易错过直接影响工作安排的信号。",
    aiUse: "AI 参与公开来源聚合、Tibo 专项监测、身份与主题分层和中文摘要；公开演示保留中英文内容与可核验 Token 原帖，私有站点每两小时检查一次真实帖子。",
